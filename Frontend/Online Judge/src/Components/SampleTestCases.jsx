...
function SampleTestCases({EditorialRef,DifficultyRef}) {
  return (
    <>
    <div className='flex mb-3 items-center'>
        ...
        <input type="text" ref={DifficultyRef} name='Difficulty' id='Difficulty' placeholder='Enter Sample Input' className=' border-none outline-none focus:border-none focus:outline-none rounded-md relative left-[16.5rem] p-2 bg-slate-100 shadow-md text-sm' style={{width:'250px',height:'28px'}}  />
    </div>
    ...
    <div className='flex mb-3 items-center'>
        ...
        <textarea name="Editorial" ref={EditorialRef} id="Editorial" rows={5} cols={5} className='mx-5 mb-5 w-[15rem] p-2 outline-none focus:outline-none resize-none overflow-auto relative left-[16rem]'></textarea>
    </div>
